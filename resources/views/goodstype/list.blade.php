...
<h4 style="color:green">商品类型列表</h4>
</blockquote>
...
<table class="table">
    <center><a href="/goodstype/create"><button type="button" class="btn btn-primary">前往添加</button></a></center>
