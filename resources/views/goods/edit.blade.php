...
<h4 style="color:green">商品修改</h4>
</blockquote>
<form class="layui-form layui-form-pane" action="/goods/update/{{$data->goods_id}}}" method="post" enctype="multipart/form-data">
...
<div class="layui-tab">
  ...
  <div class="layui-tab-content">
    ...
    <div class="layui-input-block">
      <input type="text" name="goods_name" lay-verify="title"  autocomplete="off" placeholder="请输入商品名称" class="layui-input" value="{{$data->goods_name}}">
    </div>
    </div>
    ...
    <div class="layui-input-inline">
      <input type="text" name="goods_sn" lay-verify="required" placeholder="请输入商品货号" autocomplete="off" class="layui-input" value="{{$data->goods_sn}}">
    </div>
  </div>
    ...
    <div class="layui-input-inline">
      <input type="text" name="shop_price" lay-verify="required" placeholder="请输入售价" autocomplete="off" class="layui-input" value="{{$data->shop_price}}">
    </div>
  </div>
...
<option value="{{$v->cat_id}}" selected>{{str_repeat('|--',$v->level)}}{{$v->cat_name}}</option>
    ...
    <div class="form-group">
        ...
        <div class="layui-upload-drag" id="test10">
            <input type="hidden" id="fileview" name="goods_img" value="{{$data->goods_img}}">
    ...
    <div class="layui-input-inline">
      <input type="text" name="goods_weight" lay-verify="required" placeholder="请输入商品重量" autocomplete="off" class="layui-input" value="{{$data->goods_weight}}">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="goods_number" lay-verify="required" placeholder="请输入商品存库" autocomplete="off" class="layui-input" value="{{$data->goods_number}}}}">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="warn_number" lay-verify="required" placeholder="请输入商品存库" autocomplete="off" class="layui-input" value="{{$data->warn_number}}">
