...
Route::prefix('/goodstype')->group(function(){
  Route::get('/create','Admin\GoodsTypeController@create')->name('goodstype.create');//商品类型添加
  Route::post('/store','Admin\GoodsTypeController@store')->name('goodstype.store');//执行添加
  Route::get('/list','Admin\GoodsTypeController@index')->name('goodstype.list');//类型展示
  Route::get('/destroy','Admin\GoodsTypeController@destroy')->name('goodstype.destroy');
  Route::get('/addprop/{id}','Admin\GoodsTypeController@addprop')->name('goodstype.addprop');
  Route::post('/addpropdo','Admin\GoodsTypeController@addpropdo')->name('goodstype.addpropdo');
  Route::get('/proplist/{id}','Admin\GoodsTypeController@proplist')->name('goodstype.proplist');//商品属性列表
  Route::get('/delattr','Admin\GoodsTypeController@delattr')->name('goodstype.delattr');//删除属性
  Route::get('/addattr/{id}','Admin\GoodsTypeController@addattr')->name('goodstype.delattr');//添加属性
  Route::post('/storeattr','Admin\GoodsTypeController@storeattr')->name('goodstype.storeattr');//执行添加属性
